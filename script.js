...
// 1. Массив скиллов
// 1.1 Получаем массив скиллов
var skills = _.map(newArr, "skills");

// 1.2 Делаем из него строку
skills = _.join(skills);

// 1.3 Делаем все символы в строке строчными
skills =  _.toLower(skills);

// 1.4 Преобразуем строку в массив
skills = _.split(skills, ',');

// 1.5 Убираем из массива дубли
skills = _.uniq(skills);

// 1.6 Сортируем массив по алфавиту
skills = _.sortBy(skills, [function(value) { return value; }]);


// 2. Массив имен
// 2.1 Сортируем исходный массив по количеству друзей
var names = _.sortBy(newArr, [function(o) {
  
  return o.friends.length; 
}]);

// 2.2 Получаем массив имен
names = _.map(names, "name");


// 3. Массив друзей
// 3.1  Получаем массив, состоящий из массивов с объектами, соответствующим друзьям
var friends = _.map(newArr, "friends");

// 3.2 Собираем все объекты с друзьями в один массив
var friends = _.flatten(friends);

// 3.3 Получае массив имен друзей
var friends = _.map(friends, "name");

// 3.3 Убираем из массива дубли
